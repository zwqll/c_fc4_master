...
class FCN:
  ...
  def test_naive():
    ...
    import scipy.io
    # D:\color_revise\fc4 - master\fc4 - master\data\gehler\groundtruth_568\colourchecker_gamma1_bit12.mat
    std = scipy.io.loadmat('data/gehler/groundtruth_568/colourchecker_gamma1_bit12.mat')
